...
export const PreviewCard:FC<previewProps> =  ({post}) =>{
    ...
    <div className='w-1/4 hover:w-1/3 '>
      ...
      <div className=' translate-y-[-30px] mx-2 grid justify-items-center grid-cols-2'>
            <LinkConfirm btnVarients={'secondary'} btnText={'Original Post'} btnClassName='dark:shadow-[10px_10px_10px_0px_rgba(110,110,151,0.3)]'
